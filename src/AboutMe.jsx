    ...
    >
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} sm={12} md={6} lg={8}>
          ...
          <Typography variant="body1" paragraph>
            As someone who worked as a physical therapist prior to transitioning
            into software engineering, I bring a unique perspective to team
            collaboration and interprofessional communication.
          </Typography>
          <Typography variant="body1" paragraph>
            My prior experiences enable me to excel in both working effectively
            with team members from various backgrounds and disciplines, as well
            as communicate effectively with stakeholders to ensure that the
            outcome meets the needs of the client.
          </Typography>
        </Grid>
      </Grid>
    </Box>
